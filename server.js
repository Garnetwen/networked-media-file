...
app.post("/map", (req, res) => {
  ...
  if (req.body.landfilter == "on") {
    classString += "land ";
  }
  if (req.body.waterfilter == "on") {
    classString += "water ";
  }
  if (req.body.bottlefilter == "on") {
    classString += "bottle ";
  }
  if (req.body.shellfilter == "on") {
    classString += "shell ";
  }
  notes.push({
